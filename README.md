...
Preparing the input data consists of (1) extracting simulated global mean temperature and (2) calculating the regression coefficients from CMIP6-data. Extracting the simulated  
